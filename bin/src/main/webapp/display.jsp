...
<div id="content">
		          ...
		          Connection dbcon = DriverManager.getConnection("jdbc:postgresql://localhost:5432/cab", "postgres", "happy");
		          HttpSession sess= request.getSession(false);
		          String cid=request.getParameter("cid");
		          Statement statement = dbcon.createStatement();
		          ResultSet rs=statement.executeQuery("select name,ph,model,color,no,id from driver");
		          ...
		          { 
		        	  ...
		        	  out.println("<tr><td><h2>Driver Name:</td></h2><td><h2>"+rs.getString("name")+"</h2></td></tr><tr><td><h2>Phone No:</h2></td><td><h2>"+rs.getString("ph")+"</h2></td></tr><tr><td><h2>Car Color:</h2></td><td><h2>"+rs.getString("color")+"</h2></td></tr><tr><td><h2>Car Model:</h2></td><td><h2>"+rs.getString("model")+"</h2></td></tr><tr><td><h2>Car No:</h2></td><td><h2>"+rs.getString("no")+"</h2></td></tr>");
